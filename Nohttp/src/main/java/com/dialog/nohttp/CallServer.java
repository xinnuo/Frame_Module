...
import com.ruanmeng.nohttp.HttpResponseListener;
...
public class CallServer {
    ...
    public <T> void add(Context context, Request<T> request, HttpListener<T> callback, boolean isLoading) {
        requestQueue.add(0, request, new HttpResponseDialogListener<>(context, request, callback, true, isLoading));
    }
    ...
    public <T> void add(Context context, int what, Request<T> request, HttpListener<T> callback, boolean canCancel, boolean isLoading) {
        requestQueue.add(what, request, new HttpResponseDialogListener<>(context, request, callback, canCancel, isLoading));
    }
