...
public class CardScaleHelper {
     ...
     */
    private void computeCurrentItemPos(boolean isCeil) {
        ...
        if (pageChanged) {
            ...
            mCurrentItemPos = isCeil ? (int) Math.ceil(mCurrentItemOffset / mOnePageWidth * 1.0) : mCurrentItemOffset / mOnePageWidth;
