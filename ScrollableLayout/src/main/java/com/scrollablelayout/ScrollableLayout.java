...
public class ScrollableLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(mHeadView != null){
            ...
            maxY = mHeadView.getMeasuredHeight() - mTitleHeight;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt != null) {
                if (childAt instanceof ScrollView
                        || childAt instanceof RecyclerView
                        || childAt instanceof AdapterView) {
                    mHelper.setCurrentScrollableContainer(childAt);
                }
            }
        }
    ...
    public void setTitleHeight(int y) {
        this.mTitleHeight = y;
        invalidate();
    }
